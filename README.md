# VØID — Hydrogen client demo storefront

**Showcase template** for pitching headless Shopify (Hydrogen + Remix) to clients — editorial dark techwear UI, Core Collection, live search, cart + checkout on all PDPs (preview store mapping).

→ **[DEMO.md](./DEMO.md)** — how to run, what to demo, how to clone for a client.
